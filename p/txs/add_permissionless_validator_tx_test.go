...
func TestAddPermissionlessPrimaryValidator(t *testing.T) {
	...
	// The chain sorts a tx's outputs canonically before verifying them, and
	// so does every builder. Sort here rather than hand-ordering the literal,
	// so the fixture tracks the canonical order instead of restating it.
...
func TestAddPermissionlessNetValidator(t *testing.T) {
	...
	expectedUnsignedComplexAddNetTxBytes := []byte{
		// Generated. The differential conformance test (p/txs/conformance)
		// is what pins this encoding to the chain's; this literal only
		// freezes it against accidental change.
		0x00, 0x00, 0x19, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		...
		0x39, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x99, 0x77,
		0x55, 0x77, 0x11, 0x33, 0x55, 0x31, 0x99, 0x77, 0x55, 0x77, 0x11, 0x33, 0x55, 0x31, 0x99, 0x77,
		0x55, 0x77, 0x11, 0x33, 0x55, 0x31, 0x99, 0x77, 0x55, 0x77, 0x11, 0x33, 0x55, 0x31, 0x07, 0x00,
