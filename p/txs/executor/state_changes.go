...
func advanceTimeTo(
	...
	for pendingStakerIterator.Next() {
		...
		supply, err := changes.GetCurrentSupply(stakerToRemove.ChainID)
		if err != nil {
			return nil, false, err
		}

		rewards, err := GetRewardsCalculator(backend, parentState, stakerToRemove.ChainID)
		if err != nil {
			return nil, false, err
		}
...
// removed.
//
// Ref: https://github.com/luxfi/LPs/tree/e333b335c34c8692d84259d21bd07b2bb849dc2c/LPs/77-reinventing-chains#registerl1validatortx
...
func GetRewardsCalculator(
	...
	transformNet, err := GetTransformChainTx(parentState, netID)
	if err != nil {
		return nil, err
	}
