...
// buffer. It is the whole dispatch: Unmarshal reads it and decodes the typed
// value. There is no codec, no version, no slot map.
type kind uint8
...
func kindOf(msg *zap.Message) kind { return kind(msg.Root().Uint8(offKind)) }
