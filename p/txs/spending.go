...
// entries. Built directly on github.com/luxfi/zap generic list/object
// primitives — no codec, no version prefix.
//
...
// spendPtrs are the variable-section offsets the envelope's fixed fields point
// at. Written before the object is started; set into it afterwards.
