...
// Source: vms/xvm/block/executor/manager.go
//
// Generated by this command:
//
//	mockgen -source=vms/xvm/block/executor/manager.go -destination=vms/xvm/block/executor/mock_manager.go -package=executor -exclude_interfaces=
//
