...
// Source: github.com/luxfi/protocol/x/state (interfaces: Chain,State,Diff)
//
// Generated by this command:
//
//	mockgen -package=state -destination=vms/xvm/state/mock_state.go github.com/luxfi/protocol/x/state Chain,State,Diff
//
