...
// CreateNetworkTx — create a new network (was CreateSubnetTx in upstream
// Lux v0.x). Carries the BaseTxFull spending state plus a single-address
// owner stub authorizing the network manager.
//
